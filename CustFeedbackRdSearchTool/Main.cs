    ...
    public partial class Main : Form
    {
        ...
        private void Tmimport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ImportDt = taskLogic.ResultTable.Copy();
        ...
        private void Btnsearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (GlobalClasscs.SeaData.SearchDt.Rows.Count > 0)
                {
                    _dtl = GlobalClasscs.SeaData.SearchDt;
                    panel8.Visible = true;
                    //初始化下拉框所选择的默认值
                ...
                {
                    gvdtl.DataSource = GlobalClasscs.SeaData.SearchDt;
                    panel8.Visible = false;
                }
